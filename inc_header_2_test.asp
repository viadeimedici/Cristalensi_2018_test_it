                ...
                <form action="/ricerca_avanzata_elenco.asp" class="navbar-form pull-right search-bar" role="search" name="ricerca_modulo">
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            <button class="btn btn-danger" type="submit" style="background-color:#FF972C; border-color:#DF8222;"><i class="glyphicon glyphicon-search"></i><span class="hidden-xs"> Ricerca avanzata</span></button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav nav-justified main-menu">
                    ...
                    <li class="nav-user" style="background-color:#FFE576;"><a href="/" title="Cristalensi, vendita lampadari online"><span class="glyphicon glyphicon-home" style="font-size: 18px; /*color: #D9534F;*/"></span></a></li>
