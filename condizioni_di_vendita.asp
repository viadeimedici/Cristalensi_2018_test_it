...
<head>
    ...
    <meta property="og:description" content="Condizioni di vendita ecommerce di prodotti per illuminazione da interno, illuminazione da esterno, lampadari, piantane, plafoniere, lampade esterne, ventilatori, prodotti per bambini.">
    ...
    <div class="container content">
        <div class="col-md-12">
            <div class="row top-buffer">
                <div class="col-md-8">
                    <h1 class="slogan">Condizioni di vendita Cristalensi<br />e-commerce di illuminazione</h1>
                    <p class="descrizione">
                      <small>
                    ...
                    Sul sito i prodotti sono divisi in tipologie e categorie (per facilitare la scelta, sono a disposizione del visitatore anche altri sistemi per trovare un prodotto), ogni categoria comprende i vari articoli indicandone nome del prodotto - codice - produttore - prezzo.<br />
                    Cliccando sul nome del prodotto, oppure sulla foto del prodotto o sul link "vedi scheda" accederete alla <strong>scheda del prodotto</strong>, dove sar&agrave; presente la descrizione completa del prodotto e, se presenti, altre foto del prodotto scelto.<br /><strong>Il prezzo espresso si intende comprensivo di IVA.</strong>
                    </p>
                    ...
                    <em><strong>Modalit&agrave; e costi di spedizione: </strong></em><br />
                      ...
                      <br />
                      <em><strong>Il costo di spedizione sar&agrave;  0 (zero) se il costo totale dei prodotti acquistati sar&agrave; maggiore di 250,00&euro; e la spedizione sar&agrave; in Italia</strong></em>
                      <br />
                      <br />
