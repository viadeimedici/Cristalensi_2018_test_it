...
<head>
    ...
    <meta property="og:description" content="<%if Len(Description)>0 then%><%=Description%><%else%>Cerca nel catalogo online di <%=Titolo_2%>: da Cristalensi sconti su tutti i prodotti per l'illuminazione in vendita.<%end if%>">
