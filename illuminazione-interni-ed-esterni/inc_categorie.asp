                      ...
                      <div class="info">
                          <div class="row">
                              <div class="price-details col-md-6">
                                  ...
                                  <p class="details"><span>codice: <b title="<%=codicearticolo%>"><%=codicearticolo%></b></span> <span>produttore: <b><a href="<%=url_produttore%>" title="<%=produttore%>"><%=produttore%></a></b></span></p>
